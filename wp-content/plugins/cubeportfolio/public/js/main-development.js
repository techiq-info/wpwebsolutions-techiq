...
(function($, window, document, undefined) {
    ...
    $.fn.cubeportfolio.Constructor.prototype._responsiveLayout = function() {
        var t = this,
            widthWithoutGap,
            itemWidth;
        ...
        if (t.options.coverRatio !== undefined) {
            ...
            t.blocks.each(function(index, el) {
                var data = $(el).data('cbp'),
                    cbpData = $.data(el, 'cbp-wxh'),
                    itemHeight = parseInt(cbpData.height * (itemWidth / cbpData.width), 10);
...
(function($, window, document, undefined) {
    ...
    function ResetCaption(parent) {
        ...
        parent._registerEvent('initStartWrite', function() {
...
(function($, window, document, undefined) {
    ...
    function CorrectIdFrontend(parent) {
        ...
        t.id = parent.$obj.attr('id');

        parent.$obj.attr('id', '');
        parent.wrapper.attr('id', t.id);
...
(function($, window, document, undefined) {
    ...
    $.fn.cubeportfolio.initCBP = function(id, options) {
        ...
        gridContainer.on('initComplete.cbp', function() {
            if ($(this).data('cubeportfolio').singlePage) {
