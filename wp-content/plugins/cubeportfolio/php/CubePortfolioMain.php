...
class CubePortfolioMain {
    ...
    function __construct($main_plugin_file)
    {
        ...
        add_action('init', array(&$this, 'integrate_cbp_to_vc'));
    ...
    public function register_assets()
    {
        // css
         ...
         wp_register_style( 'cubeportfolio-jquery-css', CUBEPORTFOLIO_URL . 'public/css/main.min-1.6.1.css', false, CUBEPORTFOLIO_VERSION, 'all' );

        // js
        
         wp_register_script( 'cubeportfolio-jquery-js', CUBEPORTFOLIO_URL . 'public/js/main.min-1.6.1.js', array('jquery'), CUBEPORTFOLIO_VERSION, false );
    ...
    {
        echo '<div id="cbpw-init-lightbox"></div><script type="text/javascript">jQuery(".cbp-slider").find(".cbp-slider-item").addClass("cbp-item");jQuery(".cbp-slider").cubeportfolio({layoutMode: "slider", mediaQueries: [{width: 1, cols: 1 }], gapHorizontal: 0, gapVertical: 0, caption: "", coverRatio: ""});</script>';
    }
