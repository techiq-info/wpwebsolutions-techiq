...
class CubePortfolioBackend
{
    ...
    public function register_assets()
    {
        // CUBEPORTFOLIO
         ...
         wp_register_script( 'cubeportfolio-jquery-js', CUBEPORTFOLIO_URL . 'public/js/main.min-1.6.1.js', array('jquery'), CUBEPORTFOLIO_VERSION, true );

        // ADMIN
        
         wp_register_style( 'cubeportfolio-admin-css', CUBEPORTFOLIO_URL . 'admin/css/main.min-1.6.1.css', false, CUBEPORTFOLIO_VERSION, 'all' );

        
         wp_register_script( 'cubeportfolio-admin-js', CUBEPORTFOLIO_URL . 'admin/js/main.min-1.6.1.js', array('jquery', 'jquery-ui-draggable'), CUBEPORTFOLIO_VERSION, true );
