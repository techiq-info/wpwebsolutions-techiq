...
function the_awe_des_order(id,key,url_cible,url_wtp,color)  {	
	...
	if (url_wtp!='') {
		...
		url_fin = url_cible + 'includes/admin/module-order.php?id='+id+'&key='+key+'&color='+color;
	}
