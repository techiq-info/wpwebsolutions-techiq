...
<div id="<?php echo $apex_general_settings['section_id_prefix']; ?><?php echo $hero_id; ?>-hero" <?php apex_hero_class(); ?> <?php apex_parallax_attribute('hero_bg'); ?> style="position:relative"> 
    ...
    <div id="apex-hero-overlay"></div>
		...
		<div class="container">
			<div class="apex-hero-content">
				<div id="large-header" class="large-header" style="height: 1364px; position:absolute; z-index:-999">
					<canvas id="demo-canvas" width="100%" height="975"></canvas> 
				</div>
				<?php apex_hero_logo(); ?>
